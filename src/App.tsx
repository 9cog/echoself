...
import ToroidalChat from "./components/ToroidalChat";
...
function App() {
  ...
  const [toroidalChatVisible, setToroidalChatVisible] =
        ...
        <div className="flex h-screen w-screen overflow-hidden bg-background text-foreground">
          {sidebarOpen && (
            <aside className="w-14 bg-card border-r border-border flex flex-col items-center py-4 space-y-6">
              ...
              <button
                onClick={() => setToroidalChatVisible(!toroidalChatVisible)}
                className={`p-2 rounded-md hover:bg-primary/20 transition-colors ${
                  toroidalChatVisible ? "text-primary" : "text-foreground"
                }`}
                title="Toroidal Cognitive Architecture (Dual Persona)"
              >
                <FiUsers size={24} />
              </button>
            </aside>
          ...
          <div className="flex-1 flex h-full">
            ...
            >
              ...
              {(chatVisible || toroidalChatVisible) && (
                <div
                  style={{
                    width: "400px",
                    minWidth: "300px",
                ...
                >
                  {chatVisible && <Chat />}
                  {toroidalChatVisible && <ToroidalChat />}
                </div>
              )}
