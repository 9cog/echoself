...
import { useAIChat, type AIModel } from "../services/aiChatService";
...
const Terminal = () => {
  ...
  }, []); // eslint-disable-line react-hooks/exhaustive-deps -- Intentionally empty for initialization only
  ...
  }, [terminalMounted]); // eslint-disable-line react-hooks/exhaustive-deps -- initializeTerminal is stable function defined below
